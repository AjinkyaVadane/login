...
public class activity_EventsManager extends AppCompatActivity {
    private static final String TAG = "activityEventsManager";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity__events_manager);
    }
    @Override
...
// Handle item selection
    ...
    public void sendMsgAddEvent(View view){
        DatabaseReference database  = FirebaseDatabase.getInstance().getReference();
        readDBSendMsgAddEvent();
    }


    public void sendMsgModifyEvent(View view)
    {
        DatabaseReference database  = FirebaseDatabase.getInstance().getReference();
        sendMsgModifyEvent();
    }

    public void sendMsgDeleteEvent(View view)
    {
        DatabaseReference database  = FirebaseDatabase.getInstance().getReference();
        sendMsgDeleteEvent();
    }
    ...
    private void readDBSendMsgAddEvent() {
        ...
        FirebaseDatabase.getInstance().getReference("Users/manager/manager1")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        Toast.makeText(activity_EventsManager.this, "3", Toast.LENGTH_SHORT).show();
                        ...
                        Intent intent;
                        if (value != null) {
                            Toast.makeText(activity_EventsManager.this, "4", Toast.LENGTH_SHORT).show();
                            if (value.username.equals(username)) { //if manager
                                Toast.makeText(activity_EventsManager.this, "5", Toast.LENGTH_SHORT).show();

                                intent = new Intent(activity_EventsManager.this, AddEvent.class);
                            } else { //normal user
                                intent = new Intent(activity_EventsManager.this, displayEvents.class);
                            }
                            startActivity(intent);
                        } else {
                            Toast.makeText(activity_EventsManager.this, "6", Toast.LENGTH_SHORT).show();
                        }
                    }
                    @Override
    ...
    private void sendMsgModifyEvent() {
...
//need to change
    ...
    private void sendMsgDeleteEvent() {
        ...
        FirebaseDatabase.getInstance().getReference("Users/manager/manager1")
                .addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        Toast.makeText(activity_EventsManager.this, "Delete Event", Toast.LENGTH_SHORT).show();
                        ...
                        if (value != null) {
                            ...
                            if (value.username.equals(username)) { //if manager
                                Toast.makeText(activity_EventsManager.this, "5", Toast.LENGTH_SHORT).show();
//need to change
                                intent = new Intent(activity_EventsManager.this, activity_deleteevent.class);
                            } else { //normal user
                                intent = new Intent(activity_EventsManager.this, displayEvents.class);
                            }
                            startActivity(intent);
