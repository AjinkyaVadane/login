...
public class activity_EventsStudent extends AppCompatActivity {
    private static final String TAG = "activityEventsStudent";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity__events_student);
    }
...
// Handle item selection
    ...
    public void sendMsgShowEvent(View view){
        DatabaseReference database  = FirebaseDatabase.getInstance().getReference();
        readDBSendMsgShowEvent();
    }


    public void sendMsgRegisterEvent(View view)
    {
        DatabaseReference database  = FirebaseDatabase.getInstance().getReference();
        sendMsgRegisterEvent();
    }


    private void readDBSendMsgShowEvent() {
        ...
        FirebaseDatabase.getInstance().getReference("Users/manager/manager1")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        Toast.makeText(activity_EventsStudent.this, "3", Toast.LENGTH_SHORT).show();
                        ...
                        Intent intent;
                        if (value != null) {
                            Toast.makeText(activity_EventsStudent.this, "4", Toast.LENGTH_SHORT).show();
                            if (value.username.equals(username)) { //if manager
                                Toast.makeText(activity_EventsStudent.this, "5", Toast.LENGTH_SHORT).show();

                                intent = new Intent(activity_EventsStudent.this, AddEvent.class);
                            } else { //normal user
                                intent = new Intent(activity_EventsStudent.this, displayEvents.class);
                            }
                            startActivity(intent);
                        } else {
                            Toast.makeText(activity_EventsStudent.this, "6", Toast.LENGTH_SHORT).show();
                        }
                    }
                    @Override
    ...
    private void sendMsgRegisterEvent() {
